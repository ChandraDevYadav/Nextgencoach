...
router.route("/:id").get(protect, getSkillBuilderSessionById);

router.route("/:id/message").post(protect, addConversationMessage);

router.route("/:id/feedback").post(protect, generateSkillBuilderFeedback);
